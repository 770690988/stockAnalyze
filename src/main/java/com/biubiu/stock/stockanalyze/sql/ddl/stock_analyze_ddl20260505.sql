...
) ENGINE = InnoDB AUTO_INCREMENT = 1921936 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '股票资金流向表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 990003 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '自选板块表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `stock_watchlist_bk_stock`  (
  ...
  INDEX `idx_stock_code`(`stock_code`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '自选板块股票关联表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '自选板块类型表' ROW_FORMAT = DYNAMIC;
